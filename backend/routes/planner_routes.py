...
@planner_bp.route("/on-route-suggestions", methods=["POST"])
def on_route_suggestions():
    """Get AI-powered suggestions for places along the travel route"""
    data = request.json
    ...
    suggestions = get_on_route_suggestions(from_city, to_city, travel_mode)
